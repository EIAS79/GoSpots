...
async function main() {
  ...
  const movementId = `${prefix}_movement`;
  ...
  await prisma.$executeRawUnsafe(`INSERT INTO "InventoryProfile" ("id","shopId","enabled","legacyDualMode","createdAt","updatedAt") VALUES ($1,$2,true,false,NOW(),NOW())`, profileId, shopId);
  ...
  await prisma.$executeRawUnsafe(`INSERT INTO "StockMovement" ("id","shopId","stockItemId","locationId","kind","quantityMilli","unitCostMinor","totalCostMinor","referenceType","referenceId","movementKey","actorUserId") VALUES ($1,$2,$3,$4,'TRANSFER_IN',500,125,63,'TRANSFER',$5,$6,$7)`, movementId, shopId, itemId, locB, transferId, `${prefix}:transfer:in`, userId);
