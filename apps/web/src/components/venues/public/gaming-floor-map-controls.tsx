...
export function GamingFloorMapControls({
  ...
  return (
    <div className="border-b border-white/10 bg-zinc-950/60 px-3 py-2.5">
      {mapLabel ? (
      ...
      >
        ...
        <div
          className={cn(
            "min-w-0 shrink-0",
            floorTabs
              ? "border-t border-white/10 pt-3 lg:border-l lg:border-t-0 lg:pl-4 lg:pt-0"
        ...
        >
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-5">
            <div className="min-w-0">
              ...
              <div className="flex max-w-full items-center gap-0.5 rounded-lg border border-white/10 bg-zinc-900/80 p-0.5">
                <button
                  type="button"
                  onClick={() =>
                ...
                <label className="flex min-w-0 items-center gap-1.5 px-1 text-[11px] text-zinc-200">
                  <input
                    type="date"
                    value={scheduleDate}
              ...
              <div className="flex flex-wrap items-center gap-2">
                <label className="flex min-w-0 items-center gap-1.5 text-[11px] text-zinc-400">
                  ...
                  <input
                    ...
                    className="max-w-[9.5rem] min-w-0 rounded-md border border-white/10 bg-zinc-900 px-2 py-1 text-base text-white outline-none focus:border-sky-400/40 sm:text-[11px]"
                  />
                </label>
                <label className="flex min-w-0 items-center gap-1.5 text-[11px] text-zinc-400">
                  <span>To</span>
