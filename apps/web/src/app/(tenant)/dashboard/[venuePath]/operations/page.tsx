              ...
              return (
                <article key={resource.id} className="rounded-xl border border-zinc-800 bg-zinc-950/70 p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    ...
                    {session ? <button disabled={busy !== null} onClick={() => void finishSession(resource.id, session.id)} className="min-h-11 rounded-lg border border-red-500/50 px-3 text-sm font-semibold text-red-200">Finish</button> : null}
